---
ai_description: |
  Contains PRD folders planned but not yet started. This is where a new
  PRD folder gets created on "write a PRD for X".
  ...
  qa/ subfolder (empty on creation; your QA reviewer writes QA reports here).
...
human_description: |
  ...
  - QA folder: qa/prd-007-feature-name-qa.md (created by your QA reviewer)
...
4. Create `qa/` subfolder (empty; `your QA reviewer` writes reports here).
